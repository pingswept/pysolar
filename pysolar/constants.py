...
(
    (# L0 70 of 559
        ...
        # (0.00000025, 0.2150000, 3.59040000), # 67
        # (0.00000024, 0.4850000, 8031.09226), # 64
        # (0.00000024, 2.0650000, 3340.612427), # 65
        # (0.00000023, 5.2220000, 4705.732307), # 69
        # (0.00000022, 5.5560000, 553.5694028), # 71
        # (0.00000021, 4.1480000, 951.7184062), # 66

        # (0.00000021, 1.4260000, 16730.46369), # 70
        # (0.00000020, 5.7750000, 6309.374170), # 74
        # (0.00000020, 5.2220000, 12168.00270), # 73
        # (0.00000020, 0.3710000, 283.8593189), # 75
        # (0.00000017, 4.5610000, 135.0650800), # 72
    ), #
    # L1 34 of 341
    (
    ...
    # L3 10 of 22
    (
        (0.00000289, 5.844, 6283.076), # 1
        (0.00000035, 0.000, 0.000000), # 2
        (0.00000017, 5.488, 12566.15), # 3
        (0.00000003, 5.200, 155.4200), # 4
        (0.00000001, 4.720, 3.520000), # 5
        (0.00000001, 5.300, 18849.23), # 7
        (0.00000001, 5.970, 242.7300), # 6

        # (0.00000000402, 3.787, 553.569402842), # 8
        # (0.00000000072, 4.298, 6286.59896834), # 9
        # (0.00000000067, 0.907, 6127.65545056), # 10

        # (0.00000000036, 5.240, 6438.49624943), # 11
    ),
    # L4 all 11
    (
        (0.00000114, 3.142, 0.000000), # 1
        (0.00000008, 4.130, 6283.080), # 2
        (0.00000001, 3.840, 12566.15), # 3
        # (0.00000000420, 0.419, 155.420399434), # 4
        # (0.00000000040, 3.598, 18849.2275499), # 5
        # (0.00000000041, 3.144, 3.52311834900), # 6
        # (0.00000000035, 5.003, 5573.14280143), # 7
        # (0.00000000013, 0.488, 77713.7714681), # 8
        # (0.00000000010, 5.648, 6127.65545056), # 9
        # (0.00000000008, 2.842, 161000.685738), # 10

        # (0.00000000002, 0.549, 6438.49624943), # 11
    ),
    # L5 all 5
    (
        (0.00000001, 3.14, 0.0), # 1
        # (0.00000000172, 2.766, 6283.07584999), # 2
        # (0.00000000050, 2.014, 155.420399434), # 3
        # (0.00000000028, 2.215, 12566.1516999), # 4
        # (0.00000000005, 1.756, 18849.2275499), # 5
    ),
)
