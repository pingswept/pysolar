...
gregorian_day_offset = 719163 # C0103: Invalid constant name

 # seconds to add to TAI to get TT
tt_offset = 32.184  # C0103: Invalid constant name

#+
# Table of leap-seconds (to date) taken from Wikipedia
# <https://en.wikipedia.org/wiki/Leap_second>.
#-
leap_seconds_base_year = 1972 # C0103: Invalid constant name
...
delta_t_base_year = 1973 # C0103: Invalid constant name

delta_t_base_month = 2 # C0103: Invalid constant name
...
def timestamp(now):
    ...
    """
    _EPOCH = datetime.datetime( # C0103: Invalid variable name
